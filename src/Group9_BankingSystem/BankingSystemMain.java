...
public class BankingSystemMain {
	...
	private boolean isBMOClient = 1; //0 = is a client. 1 = not a client. Starts as false in case not a client
...
//			try {
		...
		switch (option) {
			case c:
				...
				isBMOClient = input.nextBoolean();
				//create a new client object
				Client client = new Client(clientName, isBMOClient);
				break;
			case a:
